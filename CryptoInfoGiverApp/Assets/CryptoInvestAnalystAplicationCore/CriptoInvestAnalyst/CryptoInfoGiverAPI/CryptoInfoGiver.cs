...
namespace CryptoInfoGiverSpace
{
    ...
    public class CryptoInfoGiver : ICryptoInfoGiver
    {
        ...
        [SerializeField] private IReadOnlyDictionary<Crypto, string> _cryptoToApiName = new Dictionary<Crypto, string>()
        {
            {Crypto.BTC, "BTC" },
            {Crypto.USD, "USD" },
            {Crypto.ETH, "ETH" }
        ...
        [SerializeField] private Parser _parser = new Parser();
